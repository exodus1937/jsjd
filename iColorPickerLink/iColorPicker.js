/*Copyright(c)2009,www.supersite.me*/var imageUrl = 'editor_images/color.png';
...
function getColorAndInputNmae(color,id){
//	alert(id);
	//alert(id.substring(id.indexOf("history")+1,id.length));
	if(id.indexOf("_")>0){
		id = id.substring(id.indexOf("_")+1,id.length)
		var history_option = myChart_history.getOption();
		var series = history_option.series; 
		series[id].itemStyle.normal.color=color;
		myChart_history.setOption(history_option);
	}else{
