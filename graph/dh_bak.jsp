...
<div id="struct">
    <div class="struct_row struct_row_1">
        <div class="struct_cell_text struct_cell_text_1"><!--数据--></div>
        <div class="struct_line">|</div>
        <div class="struct_cell_text struct_cell_text_1_1"><!--数据--></div>
        <div class="struct_row struct_row_1_1">
            <div class="struct_line">|</div>
            <div class="struct_row struct_row_1_1_right">
            	<div style="width:100%; position: relative;">
                <div class="struct_line_0">
                    <img src="graph/show/line.jpg" style="width: 200px; height: 2px;" />
                </div>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/graph/show/dh_bak.js"></script>
<script type="text/javascript"> $(window).load(function() { common.prototype.page.nd.load(); }); </script>
<script>
