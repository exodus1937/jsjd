...
%>
	...
	<body>
			...
			<div width="198%" height="1600" > 
				...
				<!--<input type="button" value="查看当前倍数" onclick="alert(PhotoSize.cpu);" />--><br />
			<object classid="clsid:4F26B906-2854-11D1-9597-00A0C931BFC8" id="oframe" width="98%" height="600"> 
				<param name="DisplayURL" value="http://<%=ip %>:7001/jsjd/ztt/image/<%=imageName %>">
  ...
  action: function(x){
	...
	window.onload = function(){PhotoSize.init()};    	
			...
			{
			try {
			var comActiveX = new ActiveXObject('PBDCTRL.PbdCtrl.1'); // 判断IE是否已经安装视频插件
			} catch (e) {
			return false;
			}
			return true;
