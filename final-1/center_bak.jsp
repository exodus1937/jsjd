...
<span id=localtime></span>
	...
	<body style="overflow-x:hidden;">
			...
			<div id="main" style="width:1280px;margin:0 auto;">
				<!--操作区域-->
				<div id="data_one" >
				   <div style="padding-top: 5%;width: 100%;text-align: center;font-size: 20px;"> <div id="orgName"></div></div>
					...
					<div id="dateState">
                       <div style="width: 100%;float: left;">
						<div id="tupian1" style="float: left;text-aligh:center">
							<div style="float:left;font-size: 18px;text-align:left;padding-top:10px;width:30%" id="ssfhname">
								实时<br/>出力
							</div>
						...
						<div id="tupian2" style="float:right;">
							<div style="float:left;font-size: 18px;text-align:left;padding-top:10px;width:30%" id="fdlname">
								实时日<br/>发电量
							</div>
								<div class="songti" id="fdlvalue" style="line-height:54px;font-size:34px;text-align: right;width:53%;margin:inherit">
									 
							</div>
							<span style="line-height:40px;float:right;position:relative;top:34px;margin-right:-10px">万kwh</span>
						</div>
					</div>

					<div>
						<div id="tupian3" style="float: left;">
							<div style="float:left;font-size: 18px;text-align:left;padding-top:10px;width:30%" id="sspmname">
								实时<br/>排名
							</div>
						...
						<div id="tupian4" style="float:right;">
							<div style="float:left;font-size: 18px;text-align:left;padding-top:10px;width:30%"  id="dcylname">
								厂用<br/>电率
							</div>
	       ...
	       <div id="data2">
				<div id="data_five">
					...
					<div id="hhe5">
						...
						<div style="float: left;width: 100%;font-family: '楷体';font-size: 20px;font-weight: bold;margin:-8px 10px" >
