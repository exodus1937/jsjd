...
#zhibiao {
 ...
 -->
						...
						<div style="width: 95%;float: left;">
								...
								<div class="songti" id="ssfh"  style="font-size:34px;line-height:54px;margin-top:20px;text-align: right;width:53%;margin:inherit">
							...
							<div style="float:left;font-size: 18px;text-align:center;width:30%;">
								...
								<div class="songti" id="byjh" style="font-size:34px;line-height:54px;margin-top:20px;text-align: right;width:53%;margin:inherit">
							...
							<div style="float:left;font-size: 18px;text-align:center;width:30%;">
								...
								<div class="songti" id="jrfdl" style="font-size:34px;line-height:54px;text-align: right;width:53%;margin:inherit">
							...
							<div id="tupian4" style="float:right;text-align:center">
								...
								<div class="songti" id="zrfdl"  style="font-size:34px;line-height:54px;text-align: right;width:53%;margin:inherit">
							...
							<div id="tupian5" style="float: left;text-aligh:center">
								...
								<div class="songti" id="byfdl" style="font-size:34px;line-height:54px;text-align: right;width:53%;margin:inherit">
							...
							<div style="float:left;font-size: 18px;text-align:center;width:30%;">
								...
								<div class="songti" id="syfdl"  style="font-size:34px;line-height:54px;text-align: right;width:53%;margin:inherit">
							...
							<div id="tupian7" style="float: left;text-aligh:center">
								...
								<div class="songti" id="nljfdl" style="font-size:34px;line-height:54px;text-align: right;width:53%;margin:inherit">
							...
							<div id="tupian8" style="float:right;text-align:center">
								...
								<div class="songti" id="njhfdl"  style="font-size:34px;line-height:54px;text-align: right;width:53%;margin:inherit">
						...
						<div id="daohang" style="float:left;color: #000000;border: 1px;  width: 570px;height:300px;background:#f9f9f9">
					</div>
					</div>

					<div id="data_two" style="background-image:none">
