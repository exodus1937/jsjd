 ...
 <% 
  ...
  %>
	<head>
		...
		<style type="text/css">
#lineDiv { position: absolute; top: 100px; left: 100px; width: 700px; height: 365px; border: 1px solid #444; }
#lineDiv .title { position: relative; height: 27px; margin: 5px; cursor: move; }
#lineDiv .title h2 { font-size: 14px; height: 27px; line-height: 24px; border-bottom: 1px solid #A1B4B0; }
#lineDiv .title div { position: absolute; height: 19px; top: 2px; right: 0; }
#lineDiv .resizeBR { position: absolute; width: 14px; height: 14px; right: 0; bottom: 0; overflow: hidden; cursor: nw-resize; }
#lineDiv .resizeL, #lineDiv .resizeT, #lineDiv .resizeR, #lineDiv .resizeB, #lineDiv .resizeLT, #lineDiv .resizeTR, #lineDiv .resizeLB { position: absolute; background: #000; overflow: hidden; opacity: 0; filter: alpha(opacity=0); }
#lineDiv .resizeL, #lineDiv .resizeR { top: 0; width: 5px; height: 100%; cursor: w-resize; }
#lineDiv .resizeR { right: 0; }
#lineDiv .resizeT, #lineDiv .resizeB { width: 100%; height: 5px; cursor: n-resize; }
#lineDiv .resizeT { top: 0; }
#lineDiv .resizeB { bottom: 0; }
#lineDiv .resizeLT, #lineDiv .resizeTR, #lineDiv .resizeLB { width: 8px; height: 8px; background: #FF0; }
#lineDiv .resizeLT { top: 0; left: 0; cursor: nw-resize; }
#lineDiv .resizeTR { top: 0; right: 0; cursor: ne-resize; }
#lineDiv .resizeLB { left: 0; bottom: 0; cursor: ne-resize; }
</style>
...
<div >
  ...
  <div class="lineDiv" id="lineDiv">
	  ...
	  <div class="title">
    <h2>这是一个可以拖动的窗口</h2>
    <div> <a class="min"></a> <a class="max" href="javascript:;" title="最大化">+</a> <a class="revert" href="javascript:;" title="还原"></a> <a class="close" href="javascript:;" title="关闭">X</a> </div>
  </div>
