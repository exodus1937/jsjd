...
<div class="wj">
    <div class="wj1">
        <div class="wj1a">
        <span><a href="javascript:void(0)" id = "BZFG_JTBZ" >集团标准</a></span>
        <span><a href="javascript:void(0)" id = "BZFG_GJBZ">国家标准</a></span>
        <span><a href="javascript:void(0)" id = "BZFG_HYBZ">行业标准</a></span>
        <span><a href="javascript:void(0)" id = "BZFG_DCBZ">电厂标准</a></span>
        <dl>
 ...
 <script language="javascript">
	...
	function query(id){
    	...
    	for(var i=0;i < content.length;i++) {
    		...
    		t = t+ "<li><a href='${ctx}/flash/play.jsp?real_no="+content[i].real_no+"' target='_blank'><img src='img/jtbz"+content[i].ImgNum+".jpg' title='"+content[i].title+"'/></a><h1 class='dui'></h1></li>"; 
    	...
    	$show.on('click',function () {
            ...
            //获取对应的下载预览!
            var att_id = $(this).find('img').get(0).title;
