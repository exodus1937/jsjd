	...
	for (var i = 0; i < data.length; i++) {
		...
		for (var j = 0; j < columns.length; j++) {
			...
			if(table == "baojingTable"){
				...
				htmlArray.push("<td class='ellipsis' style=\""+color+"\"><a class='ellipsis' href='http://10.10.10.32:7001/jsjd/main?xwl=23WPD5TO7GWR&showAddWindow=Y&ID="+d.W_ID+"'>" + columnValue + "</a></td>");
			}
			if(table == "jianduzhixingTable"){
				htmlArray.push("<td class='ellipsis'><a class='ellipsis' href='http://10.10.10.32:7001/jsjd/main?xwl=23YYEI1R9984&executeId="+d.MOM_ID+"'>" + columnValue + "</a></td>");
			}
		
			if(table == "zongjieTable"){
			
				htmlArray.push("<td class='ellipsis' style=\""+color+"\"><a class='ellipsis' href='http://10.10.10.32:7001/jsjd/main?xwl=23YYRPL8YUSW&ORG_ID="+localStorage.getItem("orgid")+"&IS_SUMMARIZE="+d.IS_SUMMARIZE+"&S_P_TYPE="+d.S_P_TYPE+"&S_P_ID="+d.S_P_ID+"'>" + columnValue + "</a></td>");
			/*htmlArray.push("<td class='ellipsis' style=\""+color+"\">" + columnValue + "</td>");*/
			}
			if(table == "jianduTable"){
				
				htmlArray.push("<td class='ellipsis' style=\""+color+"\"><a class='ellipsis' href='http://10.10.10.32:7001/jsjd/main?xwl=23YYSVDX10MS&TEMPLETE_ID="+d.TEMPLETE_ID+"&GENERAL_ID="+d.GENERAL_ID+"'>" + columnValue + "</a></td>");
				/*htmlArray.push("<td class='ellipsis' style=\""+color+"\">" + columnValue + "</td>");*/
			}
			if(table == "yujingTable"){
