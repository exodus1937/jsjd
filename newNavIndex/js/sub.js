    ...
    //	alert(1);
        ...
        if($(this).context.className =="open"||$(this).context.className =="folder"){       
           ...
           // var url = "http://127.0.0.1:8080/jsjd/portal/supervisionReportPageData.do?orgid="+localStorage.getItem("orgid")+"&specid="+localStorage.getItem("specid")+"&pagenum=1&pagesize=1&ispage=true";
            var url = encodeURI(encodeURI(ctx + "/portal/supervisionImplementationTreeList.do?orgid="+localStorage.getItem("orgid")+"&specid="+localStorage.getItem("specid")+"&momType="+momType+"&createTime=&pagenum=1&pagesize=1"));
            console.log(url);
...
for(var i = 0;i<data.pagedata.length;i++){
						                ...
						                var $td3=$("<td >"+data.pagedata[i].CREATE_DATE.split(" ")[0]+"</td>");
