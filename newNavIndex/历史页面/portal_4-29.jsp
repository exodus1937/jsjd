			...
			<div id="d_dcyh" style='display:none'>
				...
				<div class="class_main1 fl wj_ma h293">
					<div class="du_more"></div>
						...
						<div class='fl ml20' style='height: 47px;margin-top: 62px;' id="aqts" >机组连续运行
							<!-- <div  style='text-indent:-5px; height: 30px;line-height: 30px;color: red;' id = "aqts">0天</div> -->
							<div style="text-align:left;padding-left:5px;margin-top: 14px"></div>
							<div style="text-align:left;padding-left:5px"></div>
							<div style="text-align:left;padding-left:5px" ></div>
							<div style="text-align:left;padding-left:5px"></div>
						</div>
						<div class="clearfix"></div>
						<div class="fl ml20" style="height: 20px;line-height: 20px;margin-top: 66px;">当年故障停机
	                       <div style='text-indent:-5px; height: 30px;line-height: 30px;color: red; ' id ='gztj'>0次</div>
	            		</div>
						<div class="circle" style="margin-top:28px;">
				...
				<div class="class_main1 class_main5 fl  wj_ma h213  ">
					...
					<div id="rongqi2" style="display: block;">
						<table id="baojingxinxi" class="wj_cen">
							<thead>
								<tr>
									<td style="width: 40%; overflow: hidden;">报警名称</td>
									<td style="width: 30%; ovflow: hidden">编码</td>
									<!-- <td style="width: 20%; overflow: hidden">报警级别</td>
									<td style="width: 22%; overflow: hidden">报警值</td> -->
									<td style="width: 30%; overflow: hidden">报警时间</td>
								</tr>
							</thead>
...
<script src="//cdn.bootcss.com/jquery/2.2.0/jquery.min.js"></script>
	...
	<script type="text/javascript" src="${ctx}/newNavIndex/js/portal.js?v2"></script>
