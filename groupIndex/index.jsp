        ...
        <script sype="text/javascript">
		        ...
		        document.onreadystatechange=function(){
		        	...
		        	if(document.readyState == "complete"){
		        		...
		        		getOrgs1();
		        		getWarning('0','18');
		        		getWarning('1','18');//查询预警信息0代表运行机组，1代表停机机组，22代表显示的条数
		...
		<div>
			...
			<div>
				...
				<div id="main" style="width:1280px;margin:0 auto;">
					<!--操作区域-->
					<div id="data_one" style="width:550px;margin-left:60px">
					...
					<div style="float:left;border:1px solid lightgray;margin-top:-15px;padding-top:10px;">
					<!--
						<div style="padding-top: 5%;width: 100%;text-align: center;"> <div id="orgName"></div></div>
 -->
						<div id="shijian" style="margin-top:-20px;height: 50px;line-height: 0px;">
						...
						<div style="float: left;margin-left:25px">
								...
								<div style="float:left;font-size: 18px;text-align:center;width:30%;">
									实时<br/>负荷<br>(MW)
								</div>
								<div class="songti" id="ssfh"  style="text-indent:31px;font-size:34px;line-height:54px;margin-top:20px;text-align: center;width:53%;margin:inherit">
									
								</div>
							</div>

							<div id="tupian2" style="float: right;text-aligh:center">
							<div style="float:left;font-size: 18px;text-align:center;width:30%;">
									本月<br/>计划<br>(万kWh)
								</div>
								<div class="songti" id="byjh" style="text-indent:31px;font-size:34px;line-height:54px;margin-top:20px;text-align: center;width:53%;margin:inherit">
									
									
								</div>
							</div>
							
							<div id="tupian3" style="float: left;text-aligh:center">
							<div style="float:left;font-size: 18px;text-align:center;width:30%;">
									今日<br/>发电量<br>(万kWh)
								</div>
								<div class="songti" id="jrfdl" style="text-indent:31px;font-size:34px;line-height:54px;text-align: center;width:53%;margin:inherit">
									
								</div>
							</div>

							<div id="tupian4" style="float:right;text-align:center">
								<div style="float:left;font-size: 18px;text-align:center;width:30%;">
									昨日<br/>发电量<br>(万kWh)
								</div>
								<div class="songti" id="zrfdl"  style="text-indent:31px;font-size:34px;line-height:54px;text-align: center;width:53%;margin:inherit">
									
									
								</div>
							</div>
							
							<div id="tupian5" style="float: left;text-aligh:center">
								<div style="float:left;font-size: 18px;text-align:center;width:30%;">
									本月<br/>发电量<br>(亿kWh)
								</div>
								<div class="songti" id="byfdl" style="text-indent:31px;font-size:34px;line-height:54px;text-align: center;width:53%;margin:inherit">
									
								</div>
							</div>

							<div id="tupian6" style="float:right;text-align:center">
							<div style="float:left;font-size: 18px;text-align:center;width:30%;">
									上月<br/>发电量<br>(亿kWh)
								</div>
								<div class="songti" id="syfdl"  style="text-indent:31px;font-size:34px;line-height:54px;text-align: center;width:53%;margin:inherit">
									
									
								</div>
							
							</div>
							<div id="tupian7" style="float: left;text-aligh:center">
								<div style="float:left;font-size: 18px;text-align:center;width:30%;">
									年累计<br/>发电量<br>(亿kWh)
								</div>
								<div class="songti" id="nljfdl" style="text-indent:31px;font-size:34px;line-height:54px;text-align: center;width:53%;margin:inherit">
									
								</div>
								
							</div>

							<div id="tupian8" style="float:right;text-align:center">
									<div style="float:left;font-size: 18px;text-align:center;width:30%;">
									年计划<br/>发电量<br>(亿kWh)
								</div>
								<div class="songti" id="njhfdl"  style="text-indent:31px;font-size:34px;line-height:54px;text-align: center;width:53%;margin:inherit">
									
									
								</div>
							<!--	<span style="line-height:40px;float:right;position:relative;top:34px">万KW</span> -->
							</div>
						</div>
</div>
						<div id="zhibiao" style="float: left;background-position:0px 20px;">
							<h2><b style="font-family: '楷体';">快速导航</b></h2>
						</div>
						<div id="daohang" style="margin-top:-10px;float:left;color: #000000;border: 1px; height:300px;background:#f9f9f9">
					</div>
					</div>

					<div id="data_two" style="background-image:none;width:550px;float:left;">
						<div   style="padding:5px 10px; background-repeat:no-repeat;position:relative;background-image:url(img/xian1.png) ; background-position:0px 25px;background-size:contain;">
						<h2 style="font-family: '楷体'">机组报警</h2>
					</div>

						<div class="m02-1" style="margin-bottom:9px;margin-top:-30px">
							<div id="d_3_1">
